...
const jointAngles = new Map<string, Ref<Angle>>()
...
<template>
    <div class="flex flex-row h-full">
        <!-- Vue 3D -->
        <div class="basis-full w-full h-full">
            <Viewer :targetX="targetX" :targetY="targetY" :targetZ="targetZ" :jointAngles="jointAngles" />
        </div>

        <div class="absolute z-20 basis-2/3 h-full right-0 p-4 text-4xl">
        ...
        <div v-if="inMenu && menuMouvement" class="basis-1/3 z-10 h-full bg-[#34495e55] overflow-y-scroll">
            <div class="row p-4">
        ...
        <div v-if="inMenu && menuLuminosite" class="basis-1/3 z-10 h-full overflow-y-scroll">
            <div class="row p-4">
        ...
        <div v-if="inMenu && menuCamera" class="basis-1/3 z-10 h-full overflow-y-scroll">
            <div class="row p-4">
